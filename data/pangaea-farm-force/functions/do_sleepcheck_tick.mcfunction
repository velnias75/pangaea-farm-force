...
execute if score #bett schlafzeit matches 12942..13048 run execute as @a[scores={sleeping=0},nbt={Dimension:"minecraft:overworld"}] run function pangaea-farm-force:sleep_kick
